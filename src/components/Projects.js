...
const Projects = () => {
    const projectList = [
        { title: 'Calorie Calculator Site', description: 'This link will bring you to my Calorie Calculator application built in React. This project is a simple single page web application used to automatically calculate the total calories one should consume for maintenance, cuts, and bulks.', link: 'https://macros-8f3br02wq-tfuent1s-projects.vercel.app/' },
