...
const Projects = () => {
    const projectList = [
        ...
        { title: 'Kirsti Author Site', description: 'This link brings you to an author site I built for my Fiance. While it is not completely finished yet, what is there has been built with React. It allowed me to practice UI design, and helped me learn how state management is utilized in React. Currently every part of the website has been built by hand, including the User authentication and authorization.', link: 'https://kirsti-portfolio.vercel.app/' },
        ...
        { title: 'Mental Health App (in progress)', description: 'This is a link to a demo video on Youtube of a Mental Health App I am currently developing in Flutter. It is in very early development still, but still has many working features such as Journal Entries, Duties Lists, Emotion Identifier, and Firebase intergating for User Authorization and Authentication.', link: 'https://youtu.be/_wPnnUpGP0o?si=KhobvGk_c72PSluB' },
